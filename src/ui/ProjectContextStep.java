...
public class ProjectContextStep implements WizardStep {
  ...
  public ProjectContextStep(List<String> openbisSpaces) {
    ...
    Label info =
        new Label(
            "If you want to add to an existing experiment, please select the experiment and sample(s) you want to re-use.");
  ...
  public void disableContextOptions() {
    projectContext.setItemEnabled(contextOptions.get(0), false);
