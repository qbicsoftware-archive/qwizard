...
import control.BarcodesReadyRunnable;
import control.Functions;

import ui.BarcodeView;

public class WFExperimentController {
  ...
  public WFExperimentController(BarcodeView bw, OpenBisClient openbis, String barcodeScripts,
      String pathVar) {
    view = bw;
